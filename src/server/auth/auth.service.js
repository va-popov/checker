...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.registration = function (userDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.getUserByEmail(userDto.email)];
                    case 1:
                        candidate = _a.sent();
                        if (candidate) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.usersService.createUser(__assign(__assign({}, userDto), { password: hashPassword }))];
                    case 3:
                        user = _a.sent();
                        return [2 /*return*/, this.generateToken(user)];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3: throw new common_1.UnauthorizedException({ message: "Некорректный емайл" });
                }
            });
        });
    };
