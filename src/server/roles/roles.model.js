...
var Role = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, swagger_1.ApiProperty)({ example: "ADMIN", description: "Уникальная роль пользователя" }),
        (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false })
    ], Role.prototype, "value");
    __decorate([
        (0, swagger_1.ApiProperty)({ example: "Администратор", description: "Описание роли пользователя" }),
    ...
    Role = __decorate([
        (0, sequelize_typescript_1.Table)({ tableName: 'roles' }) //оборачиваем класс в декоратор, чтобы он стал в итоге таблицей
    ], Role);
    return Role;
